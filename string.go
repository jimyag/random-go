...
func LowercaseString(length uint8) string {
	return global.String(length, lowercase)
}

func UppercaseString(length uint8) string {
	return global.String(length, uppercase)
}

func AlphabeticString(length uint8) string {
	return global.String(length, alphabetic)
}

func HexString(length uint8) string {
	return global.String(length, hex)
}
